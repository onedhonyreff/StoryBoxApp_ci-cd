...
class CreateStoryMapRepositoryTest {
    @get:Rule
    ...
    fun setup() {
        ...
        createStoryMapRepository = CreateStoryMapRepository(resources, pref, geocoder, apiService)
    }
    ...
    fun `When The postDataToServer Function Is Successful It Will Return Result and Not Null`() =
        runTest {
            ...
            val photo = file
            val position = latLng
            val expectedResponse = generateUploadStoryMapResponse()
    ...
    @Test
    fun `When Fetching Map Setting, Data Is Not Null`() = runTest {
        ...
        val actualMapSetting = createStoryMapRepository.getMapMode().getOrAwaitValue()
    ...
    fun `When Calling getAddressName It Will Do Reverse Geocoding and Not Null`() =
        runTest {
            ...
            val actualAddress = createStoryMapRepository.getAddressName(latLng)
